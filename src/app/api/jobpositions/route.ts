...
export async function GET() {
  ...
  const endpoint = resolveEndpoint((API_ENDPOINTS as any)?.jobpositions?.list, "/jobpositions");
...
export async function POST(req: Request) {
  ...
  const endpoint = resolveEndpoint((API_ENDPOINTS as any)?.jobpositions?.create, "/jobpositions");
