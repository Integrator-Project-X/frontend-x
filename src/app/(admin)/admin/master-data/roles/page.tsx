    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Search by role name + filter by status.</CardDescription>
        </CardHeader>

        <CardContent className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <form className="relative w-full md:max-w-md" action="/admin/master-data/roles" method="GET">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="mt-3 text-xs text-muted-foreground">
            ...
            <span className="font-mono">PATCH /roles/:id/desactivate</span>
          </p>
        </CardContent>
      </Card>
    </div>
