...
export async function GET() {
  ...
  const endpoint = resolveEndpoint((API_ENDPOINTS as any)?.diagnosis?.list, "/diagnosis");
...
export async function POST(req: Request) {
  ...
  const endpoint = resolveEndpoint((API_ENDPOINTS as any)?.diagnosis?.create, "/diagnosis");
