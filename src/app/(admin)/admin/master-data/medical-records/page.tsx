  ...
  <div className="space-y-6">
    <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
      <div className="space-y-1">
        ...
        <p className="text-sm text-slate-600">Master-like control (minimal fields from backend).</p>
      </div>
    ...
    <Card>
      ...
      <CardContent className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <form
          ...
          action="/admin/master-data/medical-records"
          method="GET"
        >
            ...
            {filtered.length === 0 ? (
              ...
              filtered.map((r) => (
                <TableRow key={r.id} className="transition hover:bg-slate-50">
                  <TableCell className="font-medium text-slate-800">{r.id}</TableCell>
